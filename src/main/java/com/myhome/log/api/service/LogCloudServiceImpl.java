...
public class LogCloudServiceImpl implements LogCloudService{
    ...
    @Override
    public List<LogCloudEntity> findByDayStartToEnd(String startDay, String endDay) {
        SimpleDateFormat startDateFormat = new SimpleDateFormat("yyyy-MM-dd");
        SimpleDateFormat endDateFormat = new SimpleDateFormat("yyyy-MM-dd");
        List<LogCloudEntity> resultList = new ArrayList<>();
    ...
    @Override
    public List<LogCloudEntity> findByDayStartToEndAndType(String startDay, String endDay, boolean type) {
        SimpleDateFormat startDateFormat = new SimpleDateFormat("yyyy-MM-dd");
        SimpleDateFormat endDateFormat = new SimpleDateFormat("yyyy-MM-dd");
        List<LogCloudEntity> resultList = new ArrayList<>();
